...
interface INavLinkProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {
  href: string
  exact?: boolean // Determines whether the link is exactly on the same app route e.g: "dashboard" and not "dashboard/checkout"
...
const SidebarNavLink = ({
  ...
  const isActive = useCallback(() => {
   let activeStats = exact ? pathname === href : pathname.startsWith(href)
