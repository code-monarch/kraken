...
export const fundDisbursementWalletApiSlice = baseApiSlice.injectEndpoints({
    endpoints: (builder) => ({
        fundDisbursementWallet: builder.mutation<IFundDisbursementWalletResponse, IFundDisbursementWalletPayload>({
            query: (payload) => ({
...
export const { useFundDisbursementWalletMutation } = fundDisbursementWalletApiSlice;
